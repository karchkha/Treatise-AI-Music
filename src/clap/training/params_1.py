...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        # action="store_true",
        help="use add noise to latent branch of clap to train robust clap",
    )
    parser.add_argument(
        "--train-ipc",
        type=str,
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "auto", "toy", "WavCaps", "Dcase"],
        default="auto",
    ...
    parser.add_argument(
        "--distil-loss",
        default=False,
        help="Using distilation loss for tyrainig latent clap",
    )
